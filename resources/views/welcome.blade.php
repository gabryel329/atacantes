        ...
        <main class="container">
            <div class="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
                <div class="col-lg-12 px-0" style="text-align: center">
                    <h1 class="display-4 fst-italic">Melhores Jogadores de Todos os Tempos</h1>
                </div>
            </div>
            ...
            <div class="row g-5">
                <div class="col-md-8">
                    ...
                    <article class="blog-post">
                        ...
                        <p>Prepare-se para mergulhar na história épica e nos feitos extraordinários dos maiores
                            atacantes de todos os tempos. Ao longo das décadas, esses jogadores não apenas balançaram as
                            redes, mas também encantaram multidões com sua habilidade incomparável, velocidade relâmpago
                            e instintos assassinos diante do gol.</p>

                        <p>De lendas como Pelé e Diego Maradona a fenômenos modernos como Lionel Messi e Cristiano
                            Ronaldo, os melhores atacantes inspiraram gerações com suas performances magistrais e gols
                            incríveis. Neste artigo, vamos celebrar a genialidade desses ícones do futebol e reviver
                            alguns dos momentos mais memoráveis da história do esporte.</p>
                    </article>
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li>
                                    <a class="d-flex flex-column flex-lg-row gap-3 align-items-start align-items-lg-center py-3 link-body-emphasis text-decoration-none border-top"
                                        ...
                                        <div class="col-lg-8">
                                            <h6 class="mb-0">Melhores Laterais</h6>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    <a class="d-flex flex-column flex-lg-row gap-3 align-items-start align-items-lg-center py-3 link-body-emphasis text-decoration-none border-top"
                                        ...
                                        <div class="col-lg-8">
                                            <h6 class="mb-0">Maiores Empresas de Marketing do Brasil</h6>
                                        </div>
                                    </a>
                                </li>
                            </ul>
